Ext.define('AM.controller.Types', {
  ...
  views: [
    ...
    'master.item.Form',
  	...
  	refs: [
		...
		{
			ref : 'parentList',
			selector : 'itemProcess mastergrouploanList'
		},
		{
			ref: 'list',
			selector: 'itemlist'
  ...
  init: function() {
    this.control({
			'itemProcess mastergrouploanList' : {
      ...
      'itemlist button[action=deleteObject]': {
        click: this.deleteObject
			...
			'itemProcess mastergrouploanList textfield[name=searchField]': {
	...
	onDestroy: function(){
		...
		this.getTypesStore().loadData([],false);
	},
